  ...
  return (
    <section className="py-20 md:py-32 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <Card className={`h-full ${activeTab === 'crisis' ? 'bg-slate-800 border-slate-700' : 'bg-slate-800 border-slate-700'} hover:shadow-2xl transition-all duration-300 hover:scale-105`}>
                <CardContent className="p-6">
                  ...
                  <p className="text-slate-400 text-sm mb-3">{stat.description}</p>
        ...
        >
          <div className="inline-flex items-center gap-6 p-8 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-3xl shadow-2xl">
            <div className="text-left">
              ...
              <div className="flex items-center gap-4">
                <Button 
                  size="lg" 
                  className="bg-white text-indigo-600 hover:bg-slate-100 px-8 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                >
                ...
                <div className="flex items-center gap-2 text-white/80">
                  ...
                  <span className="text-sm">6 months to job-ready</span>
                </div>
              </div>
            </div>
          </div>
