  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      <div className="relative w-full h-full max-w-4xl sm:max-w-none lg:max-w-screen-2xl mx-auto flex gap-5 sm:gap-5 lg:gap-6 justify-center">
        ...
        <div className="relative w-80 h-[380px] sm:h-[380px] lg:w-[480px] lg:h-[550px] overflow-hidden">
        ...
        <div className="relative w-80 h-[380px] sm:h-[380px] lg:w-[480px] lg:h-[550px] overflow-hidden hidden lg:block">
          {/* Desktop: No shadows */}
